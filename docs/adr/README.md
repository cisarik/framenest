...
| 0077 | Ordinary Alias Edit Affordance and Per-Field AI Suggestions | Accepted; Gallery card 🧠 bulk analyze-and-canonical-save succeeded by [ADR-0078](0078-gallery-card-ai-per-field-review.md); Gallery/Details overlay display, ordinary suggestion-list GET, hosted Load, and filename note succeeded in this file | 2026-08-26 | [0077-ordinary-alias-edit-affordance-and-per-field-ai-suggestions.md](0077-ordinary-alias-edit-affordance-and-per-field-ai-suggestions.md) |
| 0078 | Gallery Card AI Per-Field Review | Accepted | 2026-08-27 | [0078-gallery-card-ai-per-field-review.md](0078-gallery-card-ai-per-field-review.md) |
